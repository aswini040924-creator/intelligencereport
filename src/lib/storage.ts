...
export const STORAGE_KEYS = {
  ...
  PHOTO_APPROVALS: 'site2schedule_photo_approvals',
  GRIDFS_EVIDENCE: 'site2schedule_gridfs_evidence',
} as const;
...
export const storage = {
  ...
  setLocal<T>(key: string, value: T): void {
    ...
    try {
      ...
      window.dispatchEvent(new CustomEvent('site2schedule-storage', { detail: { key } }));
    } catch (e) {
