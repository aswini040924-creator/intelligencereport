...
export interface DailyTask {
  ...
  photoCount: number;
  photos?: string[]; // Attached evidence photo URLs or data URIs
  approvedPhotoCount?: number; // Number of evidence photos approved by Project Manager
  lastEvidenceAt?: string; // Timestamp of latest captured evidence
  dprCount: number;
  risk: RiskLevel;
  lastUpdated: string;
}
