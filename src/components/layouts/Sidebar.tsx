    ...
    switch (role) {
      ...
      case 'SITE_MANAGER':
        return [
          ...
          { href: '/enterprise/site-manager/reviews', label: 'Task Reviews', icon: ClipboardCheck },
